...
export SERVICE_NAME="${SERVICE_NAME:-agasa-admin}"
...
export AGASA_ADMIN_PUBLIC_BASE_URL="${AGASA_ADMIN_PUBLIC_BASE_URL:-https://agasa-admin.web.app}"
...
echo "  curl -i -H \"Authorization: Bearer \${HUB_SYNC_TOKEN}\" \"${AGASA_ADMIN_PUBLIC_BASE_URL}/api/hub/sync/convex-export?since=0&limit=5\""
